...
#ignore punctuation
print(check_wish("I wish there was an app"))
f = open("tweet.txt", "r")
inputfile = f.read()
...
f_dist_keys = FreqDist(sorted_keys)
f_dist_keys.plot(3, cumulative=False)

#named entity recognition
f_dist_names = FreqDist(get_continuous_chunks(inputfile))
f_dist_names.plot(3, cumulative=False)
