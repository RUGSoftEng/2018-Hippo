<template lang="html">
  <nav class="navbar navbar-expand-sm hippo-navbar" data-toggle="affix">
    <div class="mx-auto d-sm-flex d-block flex-sm-nowrap">
      <a class="navbar-brand" style="padding-bottom: 0; margin-right: 50px;" @click="backToHome()"><img style="height: 40px" src="../assets/Logo.svg"></a>
      ...
      <div class="collapse navbar-collapse text-center" id="navbarsExample11">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link hippo-nav-link" @click="page_search()">Search</a>
          </li>
          <li class="nav-item">
