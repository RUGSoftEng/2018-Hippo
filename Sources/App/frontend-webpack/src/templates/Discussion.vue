        ...
        <div class="comments">
            <div class="comment-wrap">
                ...
                <div class="comment-block">
                    <form action="">
                        <textarea name="" id="" class="comment-textarea" cols="30" rows="3" placeholder="Add comment..."></textarea>
                    </form>
                </div>

            </div>
            <div class="comment-wrap" style="height: 40px;">
                <button class="btn-primary float-right" style="border-radius: 5px; padding-left: 20px; padding-right: 20px;">Post</button>
            </div>
            <div class="comment-wrap">
                <div class="photo">
